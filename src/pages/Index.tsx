...
const steps = [
  {
    ...
    text: "Готовые иллюстрированные истории в нежном детском стиле",
  },
  {
    icon: "Upload",
    title: "Загрузите фото",
    text: "Одно фото лица малыша — остальное сделает нейросеть",
  },
  {
    icon: "Sparkles",
    title: "Волшебство AI",
    text: "Лицо ребёнка появляется на каждой странице истории",
  },
  {
    icon: "Package",
    title: "Печать 20×20 см",
    text: "Готовая книга в качестве для печати, формат JPEG",
  },
];
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative bg-dots">
        <div className="absolute top-20 left-[8%] text-5xl animate-float hidden md:block">
          ⭐
        </div>
        <div
          className="absolute top-40 right-[10%] text-6xl animate-float hidden md:block"
          style={{ animationDelay: "1.5s" }}
        >
          🌈
        </div>
        <div
          className="absolute bottom-20 left-[15%] text-4xl animate-float hidden md:block"
        ...
        <div className="container py-20 md:py-28 grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6">
              Ваш малыш — <span className="text-gradient">главный герой</span>{" "}
              волшебной сказки
            </h1>
            <p className="text-lg text-muted-foreground mb-8 max-w-md">
              Нейросеть бережно вставит лицо вашего ребёнка в иллюстрации
              красивой книги. Печатный формат 20×20 см.
            </p>
            <div className="flex flex-wrap gap-4">
              <Button
                onClick={() => openOrder(templates[0])}
                size="lg"
                className="rounded-full font-bold text-lg px-8 h-14 shadow-lg shadow-primary/30"
              >
              ...
              <a href="#templates">
                <Button
                  size="lg"
                  variant="outline"
                  className="rounded-full font-bold text-lg px-8 h-14 border-2"
                >
                  Посмотреть примеры
                </Button>
              </a>
      ...
      <section id="how" className="py-20 bg-muted/40">
        <div className="container">
          ...
          <p className="text-center text-muted-foreground text-lg mb-14">
            Четыре простых шага до собственной сказки
          </p>
      ...
      <section id="templates" className="py-20">
        <div className="container">
          ...
          <p className="text-center text-muted-foreground text-lg mb-14">
            Готовые иллюстрированные шаблоны книг
          </p>
            ...
            {templates.map((t, i) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {t.price > 0 && (
                    <div className="font-display font-extrabold text-xl text-primary mb-4">
                      {t.price} ₽
                    </div>
                  )}
                  <Button
      ...
      <section className="py-20 bg-muted/40">
        <div className="container max-w-2xl text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8">
            Выберите книгу, загрузите фото малыша — и увидите предпросмотр
            сразу.
          </p>
          <Button
            onClick={() => openOrder(templates[0])}
            size="lg"
            className="rounded-full font-bold text-lg px-10 h-14 shadow-lg shadow-primary/30"
          >
      ...
      <footer className="bg-foreground text-background py-12">
        <div className="container flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-background/60 text-sm">
            © 2026 Сказка с тобой. Делаем детство волшебным.
          </p>
